...
@Composable
fun HomeScreenUI(viewModel: MyViewModel = hiltViewModel(), navController: NavHostController) {
    ...
    Scaffold(
        ...
        Items(modifier = Modifier, selectedIndex,navController)
...
@Composable
fun Items(modifier: Modifier = Modifier , selectedIndex : Int,navController: NavController) {
    when(selectedIndex){
